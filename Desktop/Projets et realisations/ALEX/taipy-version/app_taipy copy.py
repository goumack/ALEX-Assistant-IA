"""
ALEX Pro - Version simplifiée avec interface Flask moderne
            ...
            def delayed_process():
                try:
                    ...
                    if self.alex_client.is_supported_file(file_path):
                        ...
                        logger.debug(f"⏭️ [AUTO] Fichier ignoré (format non supporté): {Path(file_path).name}")
...
class ALEXProClient:
    """Client ALEX Pro optimisé avec surveillance automatique"""
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.warning(f"⚠️ Surveillance automatique désactivée: {e}")
        
        logger.info("🚀 ALEX Pro initialisé - Surveillance automatique active")
            ...
            try:
                ...
                try:
                    ...
                    self.collection = self.chroma_client.create_collection(
                        name="alex_pro_docs",
                        metadata={"description": "Documents ALEX Pro"}
                    )
    ...
    def create_vector_store(self):
        ...
        try:
            ...
            collection = self.chroma_client.create_collection(
                name="alex_documents",
                metadata={"hnsw:space": "cosine", "description": "Documents ALEX Pro"}
            )
    ...
    def start_file_watcher(self):
        ...
        try:
            if not self.watch_dir.exists():
                logger.warning(f"⚠️ Répertoire de surveillance introuvable: {self.watch_dir}")
                return False
            ...
            logger.info(f"👁️ [AUTO] Surveillance automatique active: {self.watch_dir}")
            ...
            logger.warning(f"⚠️ Impossible de démarrer la surveillance automatique: {e}")
    ...
    def scan_existing_files(self):
        ...
        try:
            ...
            logger.warning(f"⚠️ Erreur lors du scan initial: {e}")
...
<head>
    ...
    <title>🤖 ALEX Pro - Assistant IA Professionnel</title>
...
<body>
    ...
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-robot"></i> ALEX Pro</h1>
            <p><i class="fas fa-sparkles"></i> Assistant IA Professionnel</p>
        </div>

        <div class="chat-container" id="chatContainer">
            <div class="message assistant-message">
                <i class="fas fa-magic" style="margin-right: 8px; opacity: 0.7;"></i>
                Bonjour ! Je suis ALEX Pro, votre assistant IA professionnel. Comment puis-je vous aider aujourd'hui ?
            </div>
        </div>
        ...
        <div class="input-section">
            <div class="input-wrapper">
                <input type="text" id="messageInput" placeholder="Posez votre question à ALEX Pro..." onkeypress="checkEnter(event)">
        ...
        <div style="text-align: center; margin-bottom: 15px;">
            ...
            <button class="clear-btn" onclick="showStatus()" style="margin-left: 10px;">
                <i class="fas fa-folder-open" style="margin-right: 8px;"></i>
                État des documents
            </button>
            <button class="send-btn" onclick="quickReindex()" style="margin-left: 10px; padding: 12px 20px; font-size: 14px;">
                <i class="fas fa-sync-alt" style="margin-right: 8px;"></i>
                Scan intelligent (cache)
            </button>
            <button class="clear-btn" onclick="diagnosticFiles()" style="margin-left: 10px; background: linear-gradient(135deg, #fd79a8, #fdcb6e);">
                <i class="fas fa-search" style="margin-right: 8px;"></i>
                Diagnostic
            </button>
            <button class="clear-btn" onclick="debugContext()" style="margin-left: 10px; background: linear-gradient(135deg, #e17055, #d63031);">
                <i class="fas fa-bug" style="margin-right: 8px;"></i>
                Debug SRMT
            </button>
            <button class="clear-btn" onclick="forceFullReindex()" style="margin-left: 10px; background: linear-gradient(135deg, #a29bfe, #6c5ce7);">
    ...
    <script>
        ...
        async function sendMessage() {
            ...
            try {
                ...
                assistantMessage.innerHTML = '<i class="fas fa-robot" style="margin-right: 8px; opacity: 0.7;"></i>';
        ...
        async function forceFullReindex() {
            if (!confirm('⚠️ Cette action va réindexer TOUS les fichiers (ignore le cache). Continuer ?')) {
                return;
            }
        ...
        async function quickReindex() {
            ...
            sendBtn.innerHTML = '<i class="fas fa-rocket" style="margin-right: 8px;"></i>Indexation optimisée...';
            sendBtn.disabled = true;
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    successMessage.className = 'message assistant-message';
                    successMessage.innerHTML = `
                        <i class="fas fa-rocket" style="margin-right: 8px; color: #2ecc71;"></i>
...
def force_full_reindex():
    ...
    try:
        ...
        try:
            ...
            logger.warning(f"⚠️ Erreur vidage: {e}")
...
def smart_reindex():
    ...
    try:
        ...
        try:
            ...
            logger.warning(f"⚠️ Erreur vidage base: {e}")
...
def diagnostic_files():
    ...
    try:
        ...
        try:
            ...
            logger.warning(f"⚠️ Erreur peek ChromaDB: {e}")
...
def app_taipy():
    """Lance l'application ALEX Pro"""
    print("🚀 Démarrage d'ALEX Pro...")
    print("=" * 50)
